...
import dev.urieloalves.studyconnect.infrastructure.api.getUserIdFromToken
import dev.urieloalves.studyconnect.infrastructure.api.route.v1.request.CreateGroupRequest
import dev.urieloalves.studyconnect.infrastructure.api.route.v1.response.GroupResponse
...
fun Route.groupRoutes() {
    ...
    route("/groups") {
        post {
            ...
            dev.urieloalves.studyconnect.infrastructure.module.Module.createGroupsUseCase.execute(
        ...
        get {
            val output = dev.urieloalves.studyconnect.infrastructure.module.Module.getGroupsByUserUseCase.execute(
        ...
        get("/search") {
            ...
            val output = dev.urieloalves.studyconnect.infrastructure.module.Module.searchGroupsUseCase.execute(
        ...
        post("/{id}/join") {
            ...
            dev.urieloalves.studyconnect.infrastructure.module.Module.joinGroupUseCase.execute(
        ...
        post("/{id}/leave") {
            val groupId = call.parameters["id"] ?: throw ServerException("Could not extract path parameter 'id'")
            dev.urieloalves.studyconnect.infrastructure.module.Module.leaveGroupUseCase.execute(
